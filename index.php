...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <b><?php echo _("News")?> </b>: <?php include "./html/news.html"; ?>
    ...
    <div id="quicksearch" style="display: none">
      ...
      <input type="text" name="qs" id="qs" size="60" tabindex="5" onKeyDown='keyPress(event, "qs")' class="hint2Textbox" placeholder="<?php echo _("Enter city, airport, airline name or code") ?>"/>
...
<tr>
  ...
  <td width=""><span id="input_trip_select"></span>
      <img id="trip_add" src="/img/icon_add.png" title="<?php echo _("Add new trip") ?>" height=17 width=17 onclick='JavaScript:editTrip("ADD")'/><img id="trip_edit" src="/img/icon_edit.png" title="<?php echo _("Edit this trip") ?>" height=17 width=17/>
  </td>
...
<tr>
  ...
  <td>
      <input type="text" name="src_ap" id="src_ap" size="60" tabindex="14" onKeyDown='keyPress(event, "src_ap")' class="hint2Textbox" placeholder="<?php echo _("Enter city name or airport code") ?>"/>
  ...
  <td>
      <input style="width: 180px" type="text" name="plane" id="plane" tabindex="111" onChange="JavaScript:markAsChanged();" onKeyDown='keyPress(event, "plane")' class="hint2Textbox" placeholder="<?php echo _("Enter plane model") ?>"><input type="hidden" id="planeid" name="planeid" />
...
<tr>
  ...
  <td>
      <input type="text" name="dst_ap" id="dst_ap" size="60" tabindex="15" onKeyDown='keyPress(event, "dst_ap")' class="hint2Textbox" placeholder="<?php echo _("Enter city name or airport code") ?>"/>
      <input type="hidden" name="dst_apid" id="dst_apid"/>
  </td>

  <td><?php echo _("Class") ?></td>
  <td>
      <input type="radio" id="myClass_Y" name="myClass" value="Y" onChange="JavaScript:markAsChanged();" CHECKED><label for="myClass_Y"><?php echo _("Economy") ?></label>
...
<tr>
  ...
  <td colspan="2">&nbsp;<?php echo _("Nr.") ?>&nbsp
    <input type="text" name="number" size="7" value="" tabindex="17" onChange='JavaScript:flightNumberToAirline("NUMBER")'/> <?php echo _("Seat") ?> <input type="text" name="seat" size="4" tabindex="18" onChange="JavaScript:markAsChanged();"/>
  ...
  <td>
    <input type="radio" id="reason_B" name="reason" value="B" onChange="JavaScript:markAsChanged();" CHECKED><label for="reason_B"><?php echo _("Work") ?></label>
...
<tr>
  ...
  <td>
      <input type="text" name="airline" id="airline" size="60" tabindex="20" onKeyDown='keyPress(event, "airline")' class="hint2Textbox" placeholder="<?php echo _("Enter airline name or code") ?>"/>
      <input type="hidden" name="airlineid" id="airlineid"/>
  </td>
  <td>
      <img id="icon_airline" src="/img/icon_airline.png" title="<?php echo _("Airline search") ?>" height=17 width=17 onclick='JavaScript:popNewAirline("airline")' style="margin-left: 5px"/>
  </td>
