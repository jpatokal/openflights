...
$sql = sprintf("INSERT INTO flights(uid, src_apid, src_time, dst_apid, duration, distance, code, seat, seat_type, class, reason, plid, alid, trid) VALUES (%s, %s, '%s', %s, '%s', %s, '%s', '%s', '%s', '%s', '%s', %s, %s, %s)",
       $uid, $src_apid, $src_date, $dst_apid, $duration, $distance, $number, $seat, $seat_type, $class, $reason, $plid, $alid, $trid);
print $sql;
