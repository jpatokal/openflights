      ...
      <div id="nonmap">
        ...
        <table>
            ...
            <tr>
              ...
              <td class="data"><?php echo _('4-letter ICAO code.<br>Null if not assigned.'); ?></td>
            </tr>
            <tr>
...
413,"Arrowhead Airways",\N,"","ARH","ARROWHEAD","United States","N"</pre>
        ...
        <p><center><a href="/demo/openflights-routedb-2048.png"><img src="/demo/openflights-routedb.png" width="512" height="256"></a><br><?php echo _('(click to enlarge)'); ?></center></p>
        ...
        <ul>
          ...
          <li><?php  echo _('Routes where one carrier operates both its own and codeshare flights are listed only once.'); ?></li>
        </ul>
...
TOM,5013,ACE,1055,BFS,465,,0,320
        ...
        <p><?php echo _("Route maps for airports and airlines can be viewed by <a href=\"https://openflights.org/blog/2009/07/15/airline-route-maps-launched-metric-distances-available/\">searching for their names or code in the website's Search box</a>; alternatively, check out the <a href=\"/html/route-maps\">alphabetical list of all covered airports and airlines</a>."); ?></p>
        ...
        <p><?php echo _('The OpenFlights plane database contains a curated selection of <b>173</b> passenger aircraft with IATA and/or ICAO codes, covering the vast majority of flights operated today and commonly used in flight schedules and reservation systems. Each entry contains the following information:'); ?></p>
        ...
        <i><?php echo _('Notes'); ?></i>:
        <ul>
          <li><?php echo _('Aircraft with IATA but without ICAO codes are generally aircraft classes: for example, IATA "747" can be any type of Boeing 747, whereas IATA "744"/ICAO "B744" is specifically a Boeing 747-400.'); ?></li>
        </ul>
...
"Boeing 787-8","788","B788"
        ...
        <p><?php echo _('The OpenFlights country database contains a list of <a href="https://en.wikipedia.org/wiki/ISO_3166-1">ISO 3166-1 country codes</a>, which can be used to look up the human-readable country names for the codes used in the Airline and Airport tables. Each entry contains the following information:'); ?></p>
...
"Ashmore and Cartier Islands",\N,"AT"
        ...
        <p><?php echo _("Airline data was extracted directly from Wikipedia's gargantuan <a href=\"https://en.wikipedia.org/en/List_of_airlines\">List of airlines</a>."); ?></p>
        <p><?php echo _("Plane data from <a href=\"https://en.wikipedia.org/wiki/List_of_ICAO_aircraft_type_designators\">List of ICAO aircraft type designators</a>."); ?></p>
        <p><?php echo _("Significant revisions and additions made by the users of OpenFlights."); ?></p>
