...
<html>
    ...
    <body>
        <div id="contexthelp">
            <h1><?php echo _('OpenFlights: Privacy policy'); ?></h1>
            ...
            <ul>
                ...
                <li><?php echo _('OpenFlights may display, package, and provide for reuse your flights, as well as any airports or airlines added by you, in an anonymized format. (See <a href="/data.html">Databases</a> for details.)'); ?></li>
