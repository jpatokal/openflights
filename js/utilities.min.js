...
function resetHintTextboxes() {var inputs = document.getElementsByTagName("input");for (i = 0; i < inputs.length; i++) {var input = inputs[i];if (input.type != "text") {continue;}if (input.className.indexOf(HintClass) != -1) {input.className = HintClass;input.value = input.hintText;}if (input.className.indexOf(miniHintClass) != -1) {input.className = miniHintClass;input.value = input.hintText;}}}

function onHintTextboxFocus() {var input = this;if (input.value.trim() == input.hintText) {input.value = "";if (input.className.indexOf(HintClass) != -1) {input.className = HintActiveClass;} else {input.className = miniHintActiveClass;}}}

function onHintTextboxBlur() {var input = this;if (input.value.trim().length == 0) {input.value = input.hintText;if (input.className.indexOf(HintClass) != -1) {input.className = HintClass;} else {input.className = miniHintClass;}}}
