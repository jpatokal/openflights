...
function alternate(table) {var tableBodies = table.getElementsByTagName("tbody");for (var i = 0; i < tableBodies.length; i++) {var tableRows = tableBodies[i].getElementsByTagName("tr");for (var j = 0; j < tableRows.length; j++) {if ((j % 2) == 0) {if (!(tableRows[j].className.indexOf("odd") == -1)) {tableRows[j].className = tableRows[j].className.replace("odd", "even");} else {if (tableRows[j].className.indexOf("even") == -1) {tableRows[j].className += " even";}}} else {if (!(tableRows[j].className.indexOf("even") == -1)) {tableRows[j].className = tableRows[j].className.replace("even", "odd");} else {if (tableRows[j].className.indexOf("odd") == -1) {tableRows[j].className += " odd";}}}}}}var hexcase = 0;var b64pad = "";var chrsz = 8;
