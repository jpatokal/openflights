...
while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
  ...
  printf ("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s", $row["src_iata"], $row["src_apid"], $row["dst_iata"], $row["dst_apid"], $row["code"], $row["src_date"], $row["distance"], $row["duration"], $row["seat"], $row["seat_type"], $row["class"], $row["reason"]);
}
?>
