  ...
  <body>
    ...
    <div id="contentContainer">
      <div id="nonmap">
        ...
        <p><?php echo _('And yes, you can enter your own flight times, either as arrival and departure times, in which case OpenFlights will figure out the duration taking into account time zones and DST, or directly into the duration box. See <a target="_blank" href="/help/time.php">Help: Time</a> for details.'); ?></p>
